...
- Think deeply about how all the pieces connect and interact
...
### Key Patterns
- **Factory Pattern**: Processor created via factory at `factories/processor.js:20`
- **Repository Pattern**: Data access abstracted in `stores/data-store.js`

### Configuration
- Settings from `config/app.js:5`
